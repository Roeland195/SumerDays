...
games: game[] =[
    ...
    new game("Blokje om","assets/images/blokjes.jpeg",4 ,"ZJE", "QxT", "", "question","Je krijgt een geheime boodschap en deze moet je ontcijferen. Haal deze op bij de spelleiders.","geniet op alle dagen van je leven die god je heeft gegeven",new quizz([]), new grid_game([],[])),
    ...
    new game("In de maneschijn in de maneschijn","assets/images/maneschijn.png",3 ,"jsa", "dTh", "", "tafel","Zoek het boek in de manenschijn","0",new quizz([]), new grid_game([],[])),
